...
- **SKILL.md**: You MUST update both the Antigravity Skill guide at [.agents/skills/cellify/SKILL.md](file:///Users/amano/works/research/supercell/.agents/skills/cellify/SKILL.md) and the Claude Code Skill guide at [.claude/skills/cellify/SKILL.md](file:///Users/amano/works/research/supercell/.claude/skills/cellify/SKILL.md) to ensure other agents can correctly utilize the updated features.
