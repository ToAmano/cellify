...
echo -e "\n4. Querying, downloading, conventionalizing, and generating a 2x2x2 Supercell of Silicon (Si):"
cellify -i Si --select 1 --conventional --dim 2 2 2 -o Si_supercell.cif
